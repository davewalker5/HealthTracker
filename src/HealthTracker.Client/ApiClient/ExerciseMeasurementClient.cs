...
namespace HealthTracker.Client.ApiClient
{
    public class ExerciseMeasurementClient : HealthTrackerClientBase, IExerciseMeasurementClient
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task<ExerciseMeasurement> Get(int id)
        {
        ...
        /// <returns></returns>
        public async Task<List<ExerciseMeasurement>> ListExerciseMeasurementsAsync(int personId, DateTime? from, DateTime? to, int pageNumber, int pageSize)
        {
