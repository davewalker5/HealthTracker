...
{
    public interface IPersonMedicationClient : IEntityRetriever<PersonMedication>
    {
        ...
        Task<List<PersonMedication>> ListPersonMedicationsAsync(int personId, int pageNumber, int pageSize);
    }
}