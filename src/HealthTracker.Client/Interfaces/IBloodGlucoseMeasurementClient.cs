...
{
    public interface IBloodGlucoseMeasurementClient
    {
        ...
        Task<List<BloodGlucoseMeasurement>> ListBloodGlucoseMeasurementsAsync(int personId, DateTime? from, DateTime? to);
    }
}