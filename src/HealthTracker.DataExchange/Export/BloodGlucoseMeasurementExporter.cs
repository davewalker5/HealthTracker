...
namespace HealthTracker.DataExchange.Export
{
    ...
    public class BloodGlucoseMeasurementExporter : IBloodGlucoseMeasurementExporter
    {
        private readonly IHealthTrackerFactory _factory;

        public event EventHandler<ExportEventArgs<ExportableBloodGlucoseMeasurement>> RecordExport;

        public BloodGlucoseMeasurementExporter(IHealthTrackerFactory factory)
            => _factory = factory;
        ...
        public async Task ExportAsync(IEnumerable<BloodGlucoseMeasurement> measurements, string file)
        {
            ...
            var exporter = new CsvExporter<ExportableBloodGlucoseMeasurement>(ExportableEntityBase.TimestampFormat);
        ...
        /// <param name="_"></param>
        /// <param name="e"></param>
        private void OnRecordExported(object _, ExportEventArgs<ExportableBloodGlucoseMeasurement> e)
        {
