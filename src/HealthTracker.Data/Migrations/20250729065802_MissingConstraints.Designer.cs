...
namespace HealthTracker.Data.Migrations
{
    ...
    [Migration("20250729065802_MissingConstraints")]
    partial class MissingConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthTracker.Entities.Food.FoodItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("HealthTracker.Entities.Food.MealConsumptionMeasurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("HealthTracker.Entities.Food.BeverageConsumptionMeasurement", b =>
                {
                    b.HasOne("HealthTracker.Entities.Food.Beverage", null)
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HealthTracker.Entities.Identity.Person", null)
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthTracker.Entities.Food.FoodItem", b =>
                {
                    b.HasOne("HealthTracker.Entities.Food.FoodCategory", "FoodCategory")
                        .WithMany()
                    ...
                    b.HasOne("HealthTracker.Entities.Food.NutritionalValue", "NutritionalValue")
                        .WithOne()
                        .HasForeignKey("HealthTracker.Entities.Food.FoodItem", "NutritionalValueId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("HealthTracker.Entities.Food.MealConsumptionMeasurement", b =>
                {
                    ...
                    b.HasOne("HealthTracker.Entities.Food.NutritionalValue", "NutritionalValue")
                        .WithOne()
                        .HasForeignKey("HealthTracker.Entities.Food.MealConsumptionMeasurement", "NutritionalValueId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("HealthTracker.Entities.Medications.PersonMedication", b =>
                {
                    b.HasOne("HealthTracker.Entities.Medications.Medication", null)
                        .WithMany()
