...
{
    public class BloodPressureMeasurementExportService : BackgroundQueueProcessor<BloodPressureMeasurementExportWorkItem>
    {
        private const string DateTimeFormat = "yyyy-MM-dd HH:mm:ss";
        private readonly HealthTrackerApplicationSettings _settings;

        public BloodPressureMeasurementExportService(
            ILogger<BackgroundQueueProcessor<BloodPressureMeasurementExportWorkItem>> logger,
            IBackgroundQueue<BloodPressureMeasurementExportWorkItem> queue,
        ...
        /// <returns></returns>
        protected override async Task ProcessWorkItemAsync(BloodPressureMeasurementExportWorkItem item, IHealthTrackerFactory factory)
        {
            ...
            MessageLogger.LogInformation("Blood pressure measurement export completed");
        }
        ...
        private void LogExportMessages(BloodPressureMeasurementExportWorkItem item, string filePath)
        {
            MessageLogger.LogInformation($"Exporting blood pressure measurements for the person with ID {item.PersonId} to {filePath}");
