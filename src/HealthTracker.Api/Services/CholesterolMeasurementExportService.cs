...
{
    public class CholesterolMeasurementExportService : BackgroundQueueProcessor<CholesterolMeasurementExportWorkItem>
    {
        private const string DateTimeFormat = "yyyy-MM-dd HH:mm:ss";
        private readonly HealthTrackerApplicationSettings _settings;

        public CholesterolMeasurementExportService(
            ILogger<BackgroundQueueProcessor<CholesterolMeasurementExportWorkItem>> logger,
            IBackgroundQueue<CholesterolMeasurementExportWorkItem> queue,
        ...
        /// <returns></returns>
        protected override async Task ProcessWorkItemAsync(CholesterolMeasurementExportWorkItem item, IHealthTrackerFactory factory)
        {
            ...
            MessageLogger.LogInformation("Cholesterol measurement export completed");
        }
        ...
        private void LogExportMessages(CholesterolMeasurementExportWorkItem item, string filePath)
        {
            MessageLogger.LogInformation($"Exporting cholesterol measurements for the person with ID {item.PersonId} to {filePath}");
