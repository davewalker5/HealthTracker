...
namespace HealthTracker.Entities.Interfaces
{
    ...
    {
        Task<Beverage> AddAsync(string name, decimal typicalABV, bool isHydrating);
        ...
        Task<Beverage> UpdateAsync(int id, string name, decimal typicalABV, bool isHydrating);
    }
}
